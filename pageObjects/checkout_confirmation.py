...
from pythonProject.Selenium_Mac.test import driver
...
class Checkout_Confirmation (BrowserUtils):
    ...
    def __init__(self, driver):
        ...
        self.checkbox = (By.CSS_SELECTOR, "[type='submit']")
    ...
    def validate_order(self):
        successText = WebDriverWait(self.driver, 10).until(EC.visibility_of_element_located(self.success_message))
        success_text = successText.text
